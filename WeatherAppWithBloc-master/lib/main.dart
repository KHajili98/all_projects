          ...
          body: MultiBlocProvider(
            providers: [
              BlocProvider<WeatherBloc>(
                builder: (BuildContext context) => WeatherBloc(WeatherRepo()),
              ),
              BlocProvider<Weather1Bloc>(
                builder: (BuildContext context) => Weather1Bloc(WeatherRepo()),
              ),
            ],
            child: SearchPage(),
          ),
            ...
            Container(
              ...
              child: FlatButton(
                ...
                onPressed: () {
                  ...
                  BlocProvider.of<Weather1Bloc>(context)
                      .add(FetchWeather1("xzccxcxz"));
                },
                color: Colors.lightBlue,
                child: Text(
                  "Search",
